//
//  PhysicsVelocityFieldTestScene.swift
//  KungFu_SpriteKitGame
//
//  Created by ChildhoodAndy on 15/3/19.
//  Copyright (c) 2015年 ChildhoodAndy. All rights reserved.
//  Thanks songrotek for https://github.com/songrotek/PhysicsFieldsWorld
...
class PhysicsFieldTestScene: GameScene {
    ...
    override func touchesBegan(touches: Set<NSObject>, withEvent event: UIEvent)
    {
        ...
        case .LinearGravityFieldDown:
            ...
            fieldTag.runAction(SKAction.rotateByAngle(CGFloat(M_PI), duration: 0.5))
            fieldNode.runAction(SKAction.rotateByAngle(CGFloat(M_PI), duration: 0.5))
